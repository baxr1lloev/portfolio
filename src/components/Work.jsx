          ...
          >
            <div>
              ...
              <p className="max-w-sm mb-16 ">
                Здесь вы сможете ознакомиться с проектами которые мы уже успели
                выполнить
              </p>
            ...
            <a href="https://ornate-stardust-6e6bb8.netlify.app/" target="_blank">
              <div
              ...
              >
               ...
               "
                ...
                <div className="absolute -bottom-full left-12 group-hover:bottom-14 transition-all duration-700 z-50">
                  <span className="text-3xl text-white ">Проект KinoArea</span>
                </div>
              </div>
            </a>
          </motion.div>
            ...
            border-2 
             ...
             "
              >
                ...
                <div className="absolute -bottom-full left-12 group-hover:bottom-14 transition-all duration-700 z-50">
                  <span className="text-3xl text-white ">Проект title</span>
                </div>
              </div>
            </a>
          </motion.div>
